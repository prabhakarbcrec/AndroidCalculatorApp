package com.example.prabhakarojha.myapp5;
...
import com.google.android.gms.common.api.GoogleApiClient;
    ...
    public class MainActivity5 extends ActionBarActivity implements View.OnClickListener {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            buttonDivide.setText(Html.fromHtml(Helperers.division));
        ...
        private void obtainInputValues(String input) {
            switch (input) {
                ...
                case "ABS":
                    ...
                    break;
                case "MR":
                    String mValue = getStoredPreferenceValue(MainActivity5.this);
