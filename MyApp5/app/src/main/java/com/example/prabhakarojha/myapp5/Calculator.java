...
/**
 * Created by prabhakarojha on 09-08-2016.
 */
        ...
        public class Calculator {
            ...
            public Calculator() {
                ...
                evaluator = new DoubleEvaluator(params) {
                    @Override
                    protected double evaluate(Object evaluationContext) {
                        Scanner arguments = null;
                        Function function;
                        if (function == sqrt) {
                            assert arguments != null;
                            return Math.sqrt((Double) arguments.next());
                        else if(function == cuberoot) return Math.cbrt((Double) arguments.next();
